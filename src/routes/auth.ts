...
const HARDCODED_DEV_USERS = {
  "pm@dotspeaks.com": { password: "pm123456", role: Role.MANAGER, name: "Project Manager" },
  "manager@dotspeaks.com": { password: "manager123", role: Role.MANAGER, name: "Manager" },
  "employee@dotspeaks.com": { password: "employee123", role: Role.OPERATOR, name: "Employee" }
};
...
router.post("/dev-login", async (req, res) => {
  try {
    ...
    // Cast to any to access the users object dynamically or define a type, but for quick fix:
    const devUser = (HARDCODED_DEV_USERS as any)[email];
